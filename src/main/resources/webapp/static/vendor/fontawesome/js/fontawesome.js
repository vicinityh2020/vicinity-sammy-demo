(function () {
  ...
  var mutators = {
    replace: function replace(mutation) {
      ...
      var newOuterHTML = abstract.sammy(function (a) {
        return toHtml(a);
      }).join('\n');
    ...
    nest: function nest(mutation) {
      ...
      var newInnerHTML = abstract.sammy(function (a) {
        return toHtml(a);
      }).join('\n');
      ...
      if (alreadyProcessedPseudoElement && !fontFamily) {
        ...
        if (!alreadyProcessedPseudoElement || alreadyProcessedPseudoElement.getAttribute(DATA_PREFIX) !== prefix || alreadyProcessedPseudoElement.getAttribute(DATA_ICON) !== iconName) {
          ...
          findIcon(iconName, prefix).then(function (main) {
            ...
            element.outerHTML = abstract.sammy(function (a) {
              return toHtml(a);
            }).join('\n');
  ...
  function apiObject(val, abstractCreator) {
    ...
    Object.defineProperty(val, 'html', {
      get: function get() {
        return val.abstract.sammy(function (a) {
          return toHtml(a);
        });
      }
    });
  ...
  var layer = function layer(assembler) {
    return apiObject({
      ...
      assembler(function (args) {
        Array.isArray(args) ? args.sammy(function (a) {
